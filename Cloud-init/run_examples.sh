...
echo -e "\n\033[1;36mExample 7: Configuration via command line options\033[0m"
echo "📝 Command line options"

CMD="python3 \"$GENERATOR\" \
    --output-dir \"$OUTPUT_DIR/07_cli_options\" \
...
echo "✅ Files generated in: $OUTPUT_DIR/07_cli_options"

# Example with compression and encoding
echo -e "\n\033[1;36mExample 8: Compressed and base64 encoded configuration\033[0m"
echo "📝 Options: --to-gzip --to-base64-encode"

CMD="python3 \"$GENERATOR\" \
    --output-dir \"$OUTPUT_DIR/08_compressed\" \
    --set-service-user-password \
    --to-gzip \
    --to-base64-encode"
echo "$CMD"
...
echo "✅ Files generated in: $OUTPUT_DIR/08_compressed"
set x
