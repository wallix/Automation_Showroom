...
### AUTORIZATIONS ###
resource "wallix-bastion_authorization" "Demo_UseCase3_Autorizations" {
  depends_on = [
    wallix-bastion_targetgroup.Demo_UseCase3_Target_Groups
  ]
  for_each           = wallix-bastion_usergroup.Demo_UseCase3_User_Groups
